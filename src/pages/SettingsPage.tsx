    ...
    supabase
      ...
      .then(({ data }) => {
        if (data) {
          ...
          setPrompt(`You are a helpful sales assistant for ${business.name}. Be friendly, concise, and helpful. Answer customer questions about products, pricing, and availability. Guide customers toward making purchases.`)
        }
        setLoading(false)
      })
  }, [business])
  ...
  async function handleSavePrompt() {
    ...
    if (promptId) {
      ...
      const { data } = await supabase
        .from('prompts')
        .insert({ business_id: business.id, content: prompt })
        .select('*')
        .single()
        ...
        <div className="card p-6">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-400">
              This prompt tells the AI how to behave when talking to customers on WhatsApp.
            </p>
          </div>
